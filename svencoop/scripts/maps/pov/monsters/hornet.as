...
class CHornet : ScriptBaseMonsterEntity
{
	...
	void IgniteTrail( void )
	{
		...
		NetworkMessage message( MSG_BROADCAST, NetworkMessages::SVC_TEMPENTITY );
			...
			case HORNET_TYPE_PRI:
				message.WriteByte( 179 );	// r, was 179
				message.WriteByte( 39 );	// g, was 39
				message.WriteByte( 14 );	// b, was 14
				break;
			case HORNET_TYPE_ALT:
				message.WriteByte( 255 );		// r, was 255	
				message.WriteByte( 128 );	// g, was 128
				message.WriteByte( 0 );	// b, was 0
				break;
			}
	...
	void TrackTarget( void )
	{
		...
		if ( flDelta < 0.5 )
		{
			...
			{
			case 0:	g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "hornet/ag_buzz1.wav", HORNET_BUZZ_VOLUME, ATTN_NORM);	break;
			case 1:	g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "hornet/ag_buzz2.wav", HORNET_BUZZ_VOLUME, ATTN_NORM);	break;
			case 2:	g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "hornet/ag_buzz3.wav", HORNET_BUZZ_VOLUME, ATTN_NORM);	break;
			}
		}
	...
	{
		if ( pOther.edict() is pev.owner || pOther.pev.modelindex == pev.modelindex || pOther.pev.takedamage == DAMAGE_NO )
		{
	...
	void DieTouch( CBaseEntity@ pOther )
	{
		if ( pOther !is null && pOther.pev.takedamage != 0.0f )
		{
			...
			switch (Math.RandomLong(0,2))
			{
				case 0:	g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "hornet/ag_hornethit1.wav", 1, ATTN_NORM);	break;
				case 1:	g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "hornet/ag_hornethit2.wav", 1, ATTN_NORM);	break;
				case 2:	g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "hornet/ag_hornethit3.wav", 1, ATTN_NORM);	break;
			}
...
/*void Register()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "CustomHornet::CHornet", "customhornet" );
}
