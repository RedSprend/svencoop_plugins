...
class monster_smallminer : CBaseCustomMonster//ScriptBaseMonsterEntity
{
	...
	void Precache( void )
	{
		...
		if( string( self.pev.model ).IsEmpty() )
		{
			...
			g_Game.PrecacheGeneric( "models/" + "wanted/smallminer01.mdl" );
			g_Game.PrecacheGeneric( "models/" + "wanted/smallminer02.mdl" );
			g_Game.PrecacheGeneric( "models/" + "wanted/smallminer03.mdl" );
			g_Game.PrecacheModel( "models/wanted/smallminerT.mdl" );
		}
